...
class LikeablePersonServiceTest {
    ...
    void t001() throws Exception {
        // 좋아하는 대상의 ID가
        List<LikeablePerson> likeablePeople = likeablePersonRepository.findByToInstaMemberId_username("insta_user4");

        System.out.println("likeablePeople = " + likeablePeople);

        likeablePersonRepository.findByFromInstaMemberIdAndToInstaMemberId_username(2L, "insta_user4");
    }
}